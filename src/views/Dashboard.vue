<template>
    <div>
        ...
        <ContentComponent>
            <AccountSetupComponent v-if="!account_ready" v-on:bank-account-saved="bankAccountSaved"></AccountSetupComponent>

            <div v-else class="app-content content">
                        ...
                        <div class="row match-height">
                            <div class="col-lg-8 col-md-12">
                                <div class="card text-center">
                                    <div class="card-content">
                                        <div class="card-body">
                                            <h1 class="card-title warning">Begin Your Savings Journey!</h1>

                                            <p class="card-text mb-1"><em>There's a popular Japanese proverb which says; <br><strong>The best time to plant a tree is 10 years ago, the next best time to plant another is now!</strong></em></p>

                                            <h2 class="card-text mb-3"><strong>Make Your First Savings!</strong></h2>

                                            <h4>Start With?</h4>

                                            <paystack :amount="1000 * 100" :email="user.email" :paystackkey="paystackkey" :reference="reference + 1" :callback="processPayment" :close="close" class="btn btn-lg btn-default m-1 font-weight-bold">₦1,000</paystack>

                                            <paystack :amount="5000 * 100" email="kamal.misc@gmail.com" :paystackkey="paystackkey" :reference="reference + 5" :callback="processPayment" :close="close" class="btn btn-lg btn-warning m-1 font-weight-bold">₦5,000</paystack>

                                            <paystack :amount="10000 * 100" email="kamal.misc@gmail.com" :paystackkey="paystackkey" :reference="reference + 10" :callback="processPayment" :close="close" class="btn btn-lg btn-primary m-1 font-weight-bold">₦10,000</paystack>

                                            <paystack :amount="20000 * 100" email="kamal.misc@gmail.com" :paystackkey="paystackkey" :reference="reference + 20" :callback="processPayment" :close="close" class="btn btn-lg btn-success m-1 font-weight-bold">₦20,000</paystack>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-4 col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Savings/Interests Accrued</h4>
                                        ...
                                        <div id="new-orders" class="media-list position-relative">
                                            <div class="table-responsive">
                                                <table id="new-orders-table" class="table table-hover table-xl mb-0">
                                                    ...
                                                    <tbody>
                                                    <tr>
                                                        <td class="text-truncate">09/03/2021</td>
...
<script>
    ...
    // import SideNavBarComponent from "./partials/SideNavBarComponent";
    ...
    export default {
        name: "Dashboard.vue",
        components: {AccountSetupComponent, FooterComponent, ContentComponent, HeaderComponent, paystack},
        data() {
            return {
                user: JSON.parse(helpers.getFromStorage('user')),
                // paystackkey: process.env.VUE_APP_PAYSTACK_KEY,
                paystackkey: 'pk_test_28324a1b0d2b2ea1fc599dfe189798f5805fa861',
                app_title: process.env.VUE_APP_TITLE,
                account_ready: JSON.parse(helpers.getFromStorage('user')).setup_complete === 1,
            }
        },
    ...
    let styles = [
        ...
        "app-assets/css/plugins/forms/selectivity/selectivity.css",
        "app-assets/vendors/css/forms/selects/selectivity-full.min.css"
    ];
    ...
    let scripts = [
        ...
        "app-assets/js/scripts/forms/select/form-selectivity.js",
        "app-assets/vendors/js/forms/select/selectivity-full.min.js",
